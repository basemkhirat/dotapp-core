...
import {Media} from "dotapp/services";
 ...
 try {
    ...
    let file = await Media.save("https://file-examples.com/wp-content/uploads/2017/10/file_example_JPG_100kB.jpg");
...
import {Media} from "dotapp/services";
 ...
 try {
    ...
    let file = await Media.save("https://file-examples.com/wp-content/uploads/2017/10/file_example_JPG_100kB.jpg", options);
